...
#     Game position in John's notation. It is guaranteed that notation is correct, 
#       but not guaranteed that it represents a valid game position.
...
# * Solution 1
def chessNotation(notation: str)-> str:
    ...
    for row in range(8):
        for col in range(8):
            newBoard[col][7-row] = board[row][col]
...
n1 = 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR'
r1 = chessNotation(n1)
print(r1)

...
# * should contain those from 104 + 1 to 2 * 104, ..., the 100th one should contain 
# * numbers from 99 * 104 + 1 to 106 and so on.
...
# * Solution 1
# ! TLE
def numbersGrouping(a:list)-> int:
    counts = [0]*100000
    step = 10000
    for num in a:
        ref = 0
        i = 0
        while ref < step*100000:
            ref += step
            if num <= ref:
                counts[i] += 1
                break
    ...
    return len(a) + len([x for x in counts if x > 0])


# * Solution 2
def numbersGrouping2(a:list)-> int:
    # b = [(x-1)//10000 for x in a]
    # print(b)
    # print(len(set(b)))
    return len(a) + len(set([(x-1)//10000 for x in a]))



a1 =  [20000, 239, 10001, 999999, 10000, 20566, 29999]
r1 = numbersGrouping2(a1)
print(r1)
...
a1 =  [10000, 20000, 30000, 40000, 50000, 60000, 10000, 120000, 150000, 200000, 300000, 1000000, 10000000, 100000000, 10000000]
r1 = numbersGrouping2(a1)
print(r1)

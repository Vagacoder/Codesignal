...
# a 31-day pass, which equals the number of days in January. The second time you 
...
# will extend your pass. The elements of the array can only be equal to 28, 30 
# or 31 and must be sorted in increasing order.

#%%

# * Solution 1
def metroCard1(lastNumberOfDays):

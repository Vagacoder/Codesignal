...
# * (rounding to 10 means increasing the next significant digit by 1). The process 
# * stops immediately once there is only one non-zero digit left.

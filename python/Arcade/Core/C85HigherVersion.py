...
# * fields. Return true if the first version is higher than the second version 
# * and false otherwise.
...
# * Solution 1
def higherVersion(ver1: str, ver2: str) -> bool:
    token1 = ver1.split('.')
    token2 = ver2.split('.')
    n = len(token1)
    for i in range(n):
...
# * Solution 2
# ! list comparison
def higherVersion2(ver1: str, ver2: str) -> bool:
    return list(map(int,ver1.split('.'))) > list(map(int,ver2.split('.')))


a1 = '1.2.2'
a2 = '1.2.0'
r1 = higherVersion(a1, a2)
print(r1)

#
# * Core 71, Minimal Number of Coins
# * Medium

# * You find yourself in Bananaland trying to buy a banana. You are super rich so 
# * you have an unlimited supply of banana-coins, but you are trying to use as 
...
def minimalNumberOfCoins(coins, price):
    ...
    # print(coins)
    for coin in coins:
        # print('coin: {}, cur: {}'.format(coin, price//coin))
        count += (price//coin)
        price = price%coin

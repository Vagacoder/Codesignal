#
# * Python 30, Create Spiral Matrix
# * Easy

# * A spiral matrix is a square matrix of size n × n. It contains all the integers 
# * in range from 1 to n * n so that number 1 is written in the bottom right corner, 
# * and all other numbers are written in increasing order spirally in the 

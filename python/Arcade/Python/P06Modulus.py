...
# Your task is to implement a function that, given a number n, returns -1 if this 
# number is not an integer and n % 2 otherwise. It is guaranteed that if the 
...
#%%
# ! Python % will give fraction result
def modulus(n)->int:
    if n%1 == 0:
        return n % 2
    else:
